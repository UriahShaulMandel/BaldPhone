...
import com.bald.uriah.baldphone.apps.credits.CreditsActivity;
import com.bald.uriah.baldphone.apps.feedback.FeedbackActivity;
    ...
    private void populateSettingsList() {
        ...
        mainCategory.add(
                new RunnableSettingsItem(R.string.set_home_screen,
                        v -> LauncherChangingUtil.resetPreferredLauncherAndOpenChooser(this)
