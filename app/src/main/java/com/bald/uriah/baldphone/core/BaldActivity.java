...
import static com.bald.uriah.baldphone.core.PermissionActivity.EXTRA_INTENT;
...
public abstract class BaldActivity extends AppCompatActivity implements SensorEventListener {
     ...
     */
    public static boolean defaultDialerGranted(BaldActivity activity) {
        return true;
    }

    public static boolean writeSettingsGranted(BaldActivity activity) {
    ...
    public static boolean notificationListenerGranted(BaldActivity activity) {
    ...
    protected void setupYoutube(int index) {
        ...
        if (baldTitleBar instanceof BaldTitleBar) {
            ((BaldTitleBar) baldTitleBar).getBt_help()
                    .setOnClickListener(
                            (v) -> startActivity(
                                    new Intent(this, VideoTutorialActivity.class)
                                            .putExtra(VideoTutorialActivity.EXTRA_ID, index)
                            )
                    );
        }
