...
import com.bald.uriah.baldphone.apps.recent_calls.Call;
...
public class SingleContactActivity extends BaldActivity {
    ...
    private void inflateAdders() {
        ...
        ToggleUtils.newTextImageToggeler(
                ...
                new View.OnClickListener[]{
                        (v) -> SOSPinningUtils.removeContact(v.getContext(), contact.getLookupKey()),
                        (v) -> {
                            if (!SOSPinningUtils.pinContact(v.getContext(), contact.getLookupKey())) {
                ...
                SOSPinningUtils.isPinned(this, contact.getLookupKey()) ? 1 : 0
        );
