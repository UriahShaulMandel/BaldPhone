...
public class ModularNestedScrollView extends NestedScrollView implements Modular {
    ...
    public ModularNestedScrollView(Context context) {
        super(context);
        touchEnabled = context.getSharedPreferences(D.BALD_PREFS, Context.MODE_PRIVATE).getBoolean(BPrefs.TOUCH_NOT_HARD_KEY, false);
    }

    public ModularNestedScrollView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        touchEnabled = context.getSharedPreferences(D.BALD_PREFS, Context.MODE_PRIVATE).getBoolean(BPrefs.TOUCH_NOT_HARD_KEY, false);
    }

    public ModularNestedScrollView(Context context, @Nullable AttributeSet attrs, int defStyle) {
