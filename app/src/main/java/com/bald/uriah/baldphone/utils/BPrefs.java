...
public final class BPrefs {
    ...
    public static final String EMERGENCY_BUTTON_NUMBER_KEY = "EMERGENCY_BUTTON_NUMBER_KEY";
    public static final String EMERGENCY_BUTTON_NUMBER_DEFAULT_VALUE = "112";
