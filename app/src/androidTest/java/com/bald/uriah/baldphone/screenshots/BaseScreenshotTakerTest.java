...
public abstract class BaseScreenshotTakerTest<T extends Activity> {
    protected static final Locale[] locales = new Locale[]{Locale.ENGLISH, Locale.FRENCH, Locale.GERMAN, Locale.forLanguageTag("es"), Locale.forLanguageTag("iw-IL"), Locale.forLanguageTag("pt"), Locale.forLanguageTag("cs"), Locale.forLanguageTag("sl")};
