...
public class ContactsActivityScreenshot extends BaseScreenshotTakerTest<ContactsActivity> {
    ...
    public void test() {
        ...
        final String[] names = context.getResources().getStringArray(R.array.names_for_screenshots);
        for (final String name : names) {
            new ContactsSaverBuilder(mActivityTestRule.getActivity()).saveContact(ContactDataFactory.createEmpty().setCompositeName(name));
        }
